...
<title> Insert Digital Products </title>
...
<i class="fa fa-dashboard"> </i> Dashboard / Insert Digital Products
...
<i class="fa fa-money fa-fw"></i> Insert Digital Products
...
<label class="col-md-3 control-label" > Singer Name </label>

<div class="col-md-6" >

<input type="text" class="form-control" name="singer"><!-- select manufacturer Starts -->
...
<label class="col-md-3 control-label" > Attach Product </label>

<div class="col-md-6" >

<input type="file" name="aud" class="form-control" required >
...
//$manufacturer_id = $_POST['singer'];
$product_price = $_POST['product_price'];
$product_desc = $_POST['product_desc'];
$product_keywords = $_POST['singer'];
...
$aud = $_FILES['aud']['name'];
$aud1 = $_FILES['aud']['tmp_name'];

move_uploaded_file($aud1,"product_images/$aud");
