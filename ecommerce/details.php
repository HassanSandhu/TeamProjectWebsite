...
<select name="product_qty" class="form-control" style="visibility:hidden;" >
...
<select name="product_size" class="form-control" style="visibility:hidden;">
...
<select name="product_qty" class="form-control" disabled>
...
<select name="product_size" class="form-control" disabled >
