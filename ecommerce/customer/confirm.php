...
$insert_payment = "select pending_orders.*,products.*
from pending_orders
inner join products on pending_orders.order_id='$order_id' and pending_orders.product_id=products.product_id";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
	   ...
	   $song =  $row["product_url"];
     $abcs= $row["product_title"];

	  $audiofile= $row["audiofile"];

$e=$_SESSION['customer_email'];
$f="/haidertesting/admin_area/product_images/";
$sql="insert into songs(email,url,pname,n) values('$e','$f','$abcs','$audiofile')";
