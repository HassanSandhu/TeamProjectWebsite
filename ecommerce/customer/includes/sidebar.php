...
<div class="container">
  ...
  <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo">Songs Links</button>
  <div id="demo" class="collapse">
    
	<?php
	
	
$sql = "SELECT * FROM songs where email='$customer_session'";
...
if ($result->num_rows > 0) {
	...
	<a href="<?php echo $row['url'].$row['n'];   ?> "download >
	
	<?php echo $row['pname'];   ?></a><br />	
		<?php
